...
Slic3r::Polygons   offset(const Slic3r::Polyline &polyline, const double delta, ClipperLib::JoinType joinType = DefaultLineJoinType, double miterLimit = DefaultLineMiterLimit);
Slic3r::Polygons   offset(const Slic3r::Polylines &polylines, const double delta, ClipperLib::JoinType joinType = DefaultLineJoinType, double miterLimit = DefaultLineMiterLimit);
