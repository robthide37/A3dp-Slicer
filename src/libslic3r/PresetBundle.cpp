...
{    
    ...
    out.option<ConfigOptionStrings>("filament_settings_id", true)->set(this->filament_presets);
    ...
    case ptFFF:
    {
        ...
        if (num_extruders <= 1) {
            ...
            if (is_external) {
                ...
                loaded = this->filaments.load_external_preset(name_or_path, name, old_filament_profile_names->get_at(0), config).first;
            } else {
